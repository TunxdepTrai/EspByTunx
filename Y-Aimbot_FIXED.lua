--[[
	...
	Y_Aimbot by Exunys © CC0 1.0 Universal (2023)
...
if Y_Aimbot or AirHubV2Loaded then
    return
end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/Y_Aimbot/main/Modules/Aimbot.lua"))()
loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/Y_Aimbot/main/Modules/Wall%20Hack.lua"))()

--// Variables

local Library = loadstring(game:GetObjects("rbxassetid://7657867786")[1].Source)() -- Pepsi's UI Library
local Aimbot, WallHack = getgenv().Y_Aimbot.Aimbot, getgenv().Y_Aimbot.WallHack
...
local MainFrame = Library:CreateWindow({
	...
	Background = "",
	Theme = [[{"__Designer.Colors.topGradient": "1E1E1E", "__Designer.Colors.section": "FF1E1E", "__Designer.Colors.hoveredOptionBottom": "B40000", "__Designer.Background.ImageAssetID": "rbxassetid://4427304036", "__Designer.Colors.selectedOption": "990000", "__Designer.Colors.unselectedOption": "5C0000", "__Designer.Files.WorkspaceFile": "Y-Aimbot", "__Designer.Colors.unhoveredOptionTop": "3D0000", "__Designer.Colors.outerBorder": "2B0000", "__Designer.Background.ImageColor": "0F0F0F", "__Designer.Colors.tabText": "B9B9B9", "__Designer.Colors.elementBorder": "160B24", "__Designer.Background.ImageTransparency": 100, "__Designer.Colors.background": "121212", "__Designer.Colors.innerBorder": "531E79", "__Designer.Colors.bottomGradient": "1E1E1E", "__Designer.Colors.sectionBackground": "21002C", "__Designer.Colors.hoveredOptionTop": "FF3333", "__Designer.Colors.otherElementText": "FF6666", "__Designer.Colors.main": "FF1E1E", "__Designer.Colors.elementText": "E06666", "__Designer.Colors.unhoveredOptionBottom": "3E0088", "__Designer.Background.UseBackgroundImage": false}]]
})
...
FunctionsSection:AddButton({
	...
	Callback = function()
		setclipboard("https://github.com/Exunys/Y_Aimbot")
	end
})
...
do
	...
	Aux.OnInvoke = function(Answer)
		...
		Library.Unload()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Exunys/Y_Aimbot-V2/main/src/Main.lua"))()
	end

	game.StarterGui:SetCore("SendNotification", {
		Title = "🎆  Y_Aimbot V2  🎆",
		Text = "Would you like to use the new Y_Aimbot V2 script?",
		Button1 = "Yes",
		Button2 = "No",
		Duration = 1 / 0,
